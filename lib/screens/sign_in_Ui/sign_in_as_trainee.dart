...
class SignInAsTrainee extends StatefulWidget {
  @override
  _SignInAsTraineeState createState() => _SignInAsTraineeState();
}

class _SignInAsTraineeState extends State<SignInAsTrainee> {
  @override
